    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div className="login-logo-icon" style={{ display: 'inline-block', padding: '15px', borderRadius: '50%', background: 'linear-gradient(135deg, var(--accent-purple), var(--accent-teal))', marginBottom: '15px' }}>
            <svg viewBox="0 0 24 24" width="30" height="30" stroke="#fff" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>
            </svg>
          </div>
          <h2 style={{ fontSize: '20px', fontWeight: 600 }}>DeadlineIQ</h2>
          <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '8px' }}>Initializing productivity engines...</p>
        </div>
      </div>
    );
  }
